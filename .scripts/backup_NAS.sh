...
sleep 0.1s ;  zip -r -q /home/pi/shares/klipper/Backup/I3A_Klipper_$file_date.zip config/ database/ logs/ 1>> /home/pi/printer_data/config/Backuplogs/log_ready.log 2>> /home/pi/printer_data/config/Backuplogs/log_fail.log
echo Backup saved into: /home/pi/shares/klipper/Backup/I3A_Klipper_$file_date.zip
echo Backup saved into: /home/pi/shares/klipper/Backup/I3A_Klipper_$file_date.zip >> /home/pi/printer_data/config/Backuplogs/log_ready.log
